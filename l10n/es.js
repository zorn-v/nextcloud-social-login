OC.L10N.register(
    ...
    "Settings for social login successfully saved" : "Las configuraciones de login social se han guardado correctamente",
    "Some error occurred while saving settings" : "Ocurrió algún error mientras se guardaban las configuraciones",
    "Do you really want to remove {providerTitle} provider ?" : "¿Realmente quiere quitar al proveedor {providerTitle}?",
    "Confirm remove" : "Confirmar supresión",
    "Save" : "Guardar",
    "Button style" : "Estilo de botones",
    "None" : "Ninguno",
    "Default group" : "Grupo por defecto",
    "Add default provider" : "Agregar proveedor por defecto",
    "Services ID" : "ID de servicios",
    "App id" : "Id de App",
    "Team ID" : "ID del equipo",
    "Key ID" : "ID de llave",
    "Key content" : "Contenido de la llave",
    "Secret" : "Secreto",
    ...
    "Allow hidden organization members to register (requests read:org scope)" : "Permitir a los miembros de la organización ocultos registrarse (requiere el ámbito read:org)",
    ...
    "Use guild nick" : "Usar apodo de gremio",
    ...
    "Disable notify admins about new users" : "Deshabilitar las notificaciones a los administradores sobre usuarios nuevos",
    ...
    "Display name claim (optional)" : "Mostrar nombre de la concesión (opcional)",
    "User info URL (optional)" : "URL de información de usuario (opcional)",
    "Logout URL (optional)" : "URL al cierre de sesión (opcional)",
    "Client Id" : "Id de cliente",
    "Client Secret" : "Secreto de cliente",
    "Scope" : "Ámbito",
    "Groups claim (optional)" : "Concesiones de grupos (opcionales)",
    "Identifier url" : "URL para identificador",
    "Custom OAuth2" : "OAuth2 personalizado",
    "API Base URL" : "URL del API base",
    "Authorize url (can be relative to base URL)" : "URL de autorización (puede ser relativa a la URL base)",
    "Token url (can be relative to base URL)" : "URL de Token (puede ser relativa a la URL base)",
