OC.L10N.register(
    ...
    "Login is available only to members of the following GitHub organizations: %s" : "Login is available only to members of the following GitHub organisations: %s",
    ...
    "Add default provider" : "Add default provider",
    ...
    "Allow login only for specified organizations" : "Allow login only for specified organisations",
    "Allow hidden organization members to register (requests read:org scope)" : "Allow hidden organisation members to register (requests read:org scope)",
    ...
    "Hide social login" : "Hide social login",
