OC.L10N.register(
    "sociallogin",
    {
    "Log in with username or email" : "Войти через имя пользователя или email",
    ...
    "Can not get identifier from provider" : "Невозможно получить идентификатор от провайдера",
    "Login from %s domain is not allowed for %s provider" : "Вход с домена %s не разрешен для поставщика %s",
    "Login is available only to members of the following GitHub organizations: %s" : "Вход разрешен только для членов следующих GitHub организаций: %s",
    ...
    "Login is available only to members of the following Discord guilds: %s" : "Вход доступен только членам следующих гильдий Discord: %s",
    ...
    "Users without assigned groups is not allowed to login, please contact support" : "Вход пользователей без группы запрещен, пожалуйста свяжитесь с техподдержкой",
    ...
    "Social Login" : "Социальный вход",
    "Social login via OAuth or OpenID" : "Вход через социальную сеть через OAuth или OpenID",
    ...
    "Services ID" : "Идентификатор услуг",
    "App id" : "Идентификатор приложения",
    "Team ID" : "ID команды",
    "Key ID" : "Идентификатор ключа",
    "Key content" : "Ключевое содержание",
    "Secret" : "Секрет",
    ...
    "Use guild nick" : "Использовать ник гильдии",
    "Add group mapping" : "Добавить групповое сопоставление",
    ...
    "Custom OpenID Connect" : "Пользовательское подключение OpenID",
    "Internal name" : "Внутреннее имя",
    "Title" : "Название",
    "Authorize url" : "Авторизовать URL",
    "Token url" : "URL токена",
    "Display name claim (optional)" : "Заявление об отображении имени (необязательно)",
    "User info URL (optional)" : "URL информации о пользователе (необязательно)",
    "Logout URL (optional)" : "URL выхода (необязательно)",
    "Client Id" : "Идентификатор клиента",
    "Client Secret" : "Секрет клиента",
    "Scope" : "Объем",
    "Identifier url" : "URL-адрес идентификатора",
    "Custom OAuth2" : "Пользовательский OAuth2",
    "API Base URL" : "Базовый URL-адрес API",
    "Authorize url (can be relative to base URL)" : "URL-адрес авторизации (может быть относительно базового URL-адреса)",
    "Token url (can be relative to base URL)" : "URL-адрес токена (может быть относительно базового URL-адреса)",
