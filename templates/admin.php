...
<div id="sociallogin" class="section">
    <form id="sociallogin_settings" action="<?php print_unescaped($_['action_url']) ?>" method="post">
        ...
        <div>
            <input id="update_on_login" type="checkbox" class="checkbox" name="update_on_login" value="1" <?php p($_['update_on_login'] ? 'checked' : '') ?>/>
            <label for="update_on_login"><?php p($l->t('Update user data every login')) ?></label>
        </div>
        </p>
